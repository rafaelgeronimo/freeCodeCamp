...
var averageRating = watchList.filter( obj => obj.Director == "Christopher Nolan" );
    //console.log(averageRating);
    averageRating = averageRating.map( obj => +obj.imdbRating);
    //console.log(averageRating);
    averageRating = averageRating.reduce( (acc,cur,index) =>  (acc*index + cur) / (index + 1), 0 );
